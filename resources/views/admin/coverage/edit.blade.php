...
@section('breadcrumb')
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage') }}"><i class="fas fa-shipping-fast"></i>Editar Cobertura de envios</a>
    </li>
    <li class="breadcrumb-item">
        <a href="{{ url('/admin/coverage/state/'.$coverage->id.'/edit') }}"><i class="fas fa-edit"></i>Editar Provincias / Ciudades</a>
    </li>
@endsection
@section('content')
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-edit"></i>Editar cobertura de envío</h2>
                    </div>
                    <div class="inside">
            ...
            <div class="col-md-3">
                <div class="panel shadow">
                    ...
                    <div class="inside">
                        ...
                        <p><strong>Provincia / Ciudad: </strong>{{ $coverage->name }}</p>
