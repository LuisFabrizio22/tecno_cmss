        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-plus"></i>Agregar Provincia / Ciudad</h2>
                    </div>
                    <div class="inside">
            ...
            <div class="col-md-9">
                <div class="panel shadow">
                    <div class="header">
                        <h2 class="title"><i class="fas fa-shipping-fast"></i>Listado de Ciudades / Provincias</h2>
                    </div>
                    <div class="inside">
                                    ...
                                    <td>
                                        <div class="opts">
                                            ...
                                            <a href="{{ url('/admin/coverage/' . $state->id . '/cities') }}"
                                                data-toggle="tooltip" data-placement="top" title="Ciudades" class="inventory">
