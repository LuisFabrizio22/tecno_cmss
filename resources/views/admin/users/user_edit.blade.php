                        ...
                        <div class="inside">
                            <div class="mini_profile">
                                ...
                                <div class="info">
                                    ...
                                    <span class="title"><i class="fas fa-user-shield"></i>Estado Usuario:</span>
                                ...
                                @if (kvfj(Auth::user()->permissions, 'user_banned'))
                                    @if ($u->status == '100')
                                        <a href="{{ url('/admin/user/' . $u->id . '/banned') }}" class="btn btn-success">Activar
                                            Usuario</a>

                                    @else
                                        <a href="{{ url('/admin/user/' . $u->id . '/banned') }}"
                                            class="btn btn-danger">Suspender Usuario</a>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            ...
                                            {!! Form::select('user_type', getRoleUserArray('list', null), $u->role, 
                                            ['class'=>'form-select']) !!}
