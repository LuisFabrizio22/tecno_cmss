        ...
        <div class="col-md-4">
            <div class="panel shadow">
                ...
                <div class="inside">
                        <div class="edit_avatar">
                            {!! Form::open(['url' => 'account/edit/avatar', 'files' => true, 'id'=>'form_avatar_change']) !!}
            ...
            <div class="panel shadow mtop32">
                ...
                <div class="inside">
                    ...
                    <div class="row mtop16">
                        <div class="col-md-8">
                            <label for="name">Confirmar contraseñia:</label>
                            <div class="input-group">
                    ...
                    <div class="row mtop16">
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="input-group">
                                ...
                                {!! Form::number('year', $birthday[0], ['class' => 'form-select', 'min' => getUserYears()[1], 'max' => getUserYears()[0], 'required']) !!}
